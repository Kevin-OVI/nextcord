...
extlinks = {
    "issue": ("https://github.com/nextcord/nextcord/issues/%s", "GH-%s"),
...
version = ""
p = subprocess.Popen(
    ["git", "describe", "--tags", "--abbrev=0"], stdout=subprocess.PIPE, stderr=subprocess.PIPE
)
...
branch_version = re.sub(r"(\d+)\.(\d+)\.\d+", r"v\1.\2.x", version)

if branch_version == "v0.0.x":
    branch_version = "stable"

# This assumes a tag is available for final releases
branch = "master" if any(c in version for c in ("a", "b", "rc")) else branch_version
...
latex_documents = [
    ("index", "nextcord.tex", "nextcord Documentation", "Rapptz", "manual"),
]
